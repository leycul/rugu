...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="resources/fonts/pe-icon/pe-icon.css">
		<!-- Vendors-->
		<link rel="stylesheet" type="text/css" href="resources/vendors/bootstrap/grid.css">
		<link rel="stylesheet" type="text/css" href="resources/vendors/magnific-popup/magnific-popup.min.css">
		<link rel="stylesheet" type="text/css" href="resources/vendors/swiper/swiper.css">
		<!-- App & fonts-->
	...
	<body>
		<div class="page-wrap" id="root">
			...
			<header class="header header--fixed">
				<div class="header__inner">
					<div class="header__logo"><a href="index.html"><img src="resources/img/logo.png" alt="" style="width: 122px;"/></a></div>
					...
					<div class="container">
						...
						<div>
							<div class="work-detail__entry">
								...
								<div class="work-img"><img src="resources/img/works/01.jpg" alt=""></div>
								<div class="work-img"><img src="resources/img/works/02.jpg" alt=""></div>
								<div class="work-img"><img src="resources/img/works/03.jpg" alt=""></div>
							</div>
		...
		<script type="text/javascript" src="resources/vendors/imagesloaded/imagesloaded.pkgd.js"></script>
		<script type="text/javascript" src="resources/vendors/isotope-layout/isotope.pkgd.js"></script>
		<script type="text/javascript" src="resources/vendors/jquery-one-page/jquery.nav.min.js"></script>
		<script type="text/javascript" src="resources/vendors/jquery.easing/jquery.easing.min.js"></script>
		<script type="text/javascript" src="resources/vendors/jquery.matchHeight/jquery.matchHeight.min.js"></script>
		<script type="text/javascript" src="resources/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
		<script type="text/javascript" src="resources/vendors/masonry-layout/masonry.pkgd.js"></script>
		<script type="text/javascript" src="resources/vendors/jquery.waypoints/jquery.waypoints.min.js"></script>
		<script type="text/javascript" src="resources/vendors/swiper/swiper.jquery.js"></script>
		<script type="text/javascript" src="resources/vendors/menu/menu.js"></script>
		<script type="text/javascript" src="resources/vendors/typed/typed.min.js"></script>
		<!-- App-->
