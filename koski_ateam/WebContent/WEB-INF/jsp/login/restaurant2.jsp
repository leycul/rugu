			...
			<div class="wil-content">
				...
				<div class="container">
					...
					<div class="page-title pb-40" id="sub_title">
						<h2 class="page-title__title">식당 상세 페이지</h2>
				...
				<section class="awe-section bg-gray">
					<div class="container">
						...
						<!--  -->
						<div>
							<div class="post-detail__media"><img src="resources/img/login/img/경아식당.jpg" alt=""/></div>
						...
						<div class="awe-text-center mt-50">
							<a class="md-btn md-btn--outline-primary " href="restaurant">All block content
							</a>
						</div>
					</div>
				</section>
