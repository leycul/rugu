			...
			<div class="wil-content">
				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="page-title pb-40">
							...
							<h2 class="page-title__title">추천 숙박업소 상세페이지</h2>
				...
				<section class="awe-section bg-gray">
					<div class="container">
						...
						<!--  -->
						<div>
							<div class="post-detail__media"><img src="resources/img/login/img/비발디펜션.jpg" alt=""/></div>
						...
						<div class="awe-text-center mt-50">
							<a class="md-btn md-btn--outline-primary " href="hotel1">All block content
							</a>
						</div>
					</div>
				</section>
