...
<%@include file="header1.jsp"%>
	<!-- End Sidebar -->
	<div id="divpopup_movie_1" class="main_popup" style="display:none; position:absolute; left:10px; top:335px; z-index:10; visibility:visible;  width:320px; height:197px; background:#000">
		<div style="padding: 5px; color: #fff; text-align: center">건우 리조트</div>
		<div class="layer_cont" style="background: #000">
			<video id="video1"width="320" height="197" controls="" poster="/site/www/images/main/cf_bg_191223.jpg">
				<source src="http://mvod.kangwonland.smartucc.kr/encodeFile/3223/2019/12/23/dc1db6d9346db291958dcda6792a3f2a_W.mp4" type="video/mp4">
				<p class="p-media__support">
					 <br>
					[<a href="http://mvod.kangwonland.smartucc.kr/encodeFile/3223/2019/12/23/dc1db6d9346db291958dcda6792a3f2a_W.mp4">[</a>]
				</p>
			</video>
		</div>
	 
		<form name="notice_movie_form_1">		
			<div class="layer_put clearfix" style="background:#000;padding:3px 0">
				<div style="float:left; color:#fff; font-weight:bold; "><input type="checkbox" name="chkbox1" id="chkbox1" value="checkbox" />오늘하루안봐요<label for="chkbox1"></label></div>
				
				<div style="float:right; font-weight:bold;"><a href="javascript:closeMovieWind1();" style="color:#ffff00;">[close]</a></div>
			</div>
		</form> 
</div>
<script type="text/JavaScript">
//<![CDATA[
	function closeMovieWind1() {
		if ( document.notice_movie_form_1.chkbox1.checked ){
			setCookie( "maindiv982", "done" , 1 );
		}
		var video = $("#video1").get(0);
		video.pause();
		$("#divpopup_movie_1").attr("style","display:none");
		
	}

	cookiedata = document.cookie;
	if ( cookiedata.indexOf("maindiv982=done") < 0 ){
		document.all['divpopup_movie_1'].style.display = "block";
	}
	else {
		document.all['divpopup_movie_1'].style.display = "none";
	}
//]]>
</script>	
			...
			<div class="row">
				<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
					<div class="card-box noradius noborder bg-default">
						...
						<h6 class="text-white text-uppercase m-b-20">홈페이지방문수</h6>
						<h1 class="m-b-20 text-white counter">3,000</h1>
						<span class="text-white">방문수체크</span>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
					<div class="card-box noradius noborder bg-warning">
						...
						<h6 class="text-white text-uppercase m-b-20">누적 방문객</h6>
						<h1 class="m-b-20 text-white counter">250</h1>
						<span class="text-white">Update today at 12:00 PM</span>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
					<div class="card-box noradius noborder bg-info">
						...
						<h6 class="text-white text-uppercase m-b-20">입장 고객 수</h6>
						<h1 class="m-b-20 text-white counter">120</h1>
						<span class="text-white">Update 1 hour now</span>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
					<div class="card-box noradius noborder bg-danger">
						...
						<h6 class="text-white text-uppercase m-b-20">불편사항 신고 및 문의</h6>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
					<div class="card mb-3">
						<div class="card-header">
							<h3>
								<i class="fa fa-line-chart"></i> 전년 방문객 비교
							</h3>
							Dataset 1 : 전년  , Dataset 2 : 금년
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
					<div class="card mb-3">
						<div class="card-header">
							<h3>
								<i class="fa fa-bar-chart-o"></i> 이용비중 
							</h3>
							각 구간별 이용 비중 
						</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
					<div class="card mb-3">
						<div class="card-header">
							<h3>
								<i class="fa fa-bar-chart-o"></i> 통계2
							</h3>
				...
				<!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-3">
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							<div class="progress">
								<div
									class="progress-bar progress-bar-striped progress-xs bg-primary"
							...
							<div class="progress">
								<div
									class="progress-bar progress-bar-striped progress-xs bg-info"
									role="progressbar" style="width: 78%" aria-valuenow="75"
							...
							<div class="progress">
								<div
									class="progress-bar progress-bar-striped progress-xs bg-warning"
							...
							<div class="progress">
								<div
									class="progress-bar progress-bar-striped progress-xs bg-danger"
								...
								<a href="#">
									<div class="message-item">
										<div class="message-user-img">
											<img src="resources/admin/assets/images/avatars/avatar2.png"
												class="avatar-circle" alt="">
										</div>
										<p class="message-item-user">John Doe</p>
										<p class="message-item-msg">Hello. I want to buy your
											product</p>
									...
									<div class="message-item">
										<div class="message-user-img">
											<img src="resources/admin/assets/images/avatars/avatar5.png"
												class="avatar-circle" alt="">
										</div>
									...
									<div class="message-item">
										<div class="message-user-img">
											<img src="resources/admin/assets/images/avatars/avatar6.png"
												class="avatar-circle" alt="">
										</div>
									...
									<div class="message-item">
										<div class="message-user-img">
											<img src="resources/admin/assets/images/avatars/avatar10.png"
												class="avatar-circle" alt="">
										</div>
									...
									<div class="message-item">
										...
										<p class="message-item-msg">Hello! I'm available for this
											job</p>
										<p class="message-item-date">15:45 AM</p>
									</div>
								</a> <a href="#">
...
<!-- BEGIN Java Script for this page -->
	...
	<!-- Counter-Up-->
	<script src="resources/admin/assets/plugins/waypoints/lib/jquery.waypoints.min.js"></script>
	<script src="resources/admin/assets/plugins/counterup/jquery.counterup.min.js"></script>			
	<script>
